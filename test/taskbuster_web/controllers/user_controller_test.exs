defmodule TaskbusterWeb.UserControllerTest do
  use TaskbusterWeb.ConnCase

  alias Taskbuster.Accounts

  @create_attrs %{email: "some email", name: "some name", password: "some password", username: "some username"}
